...
export function VertPage({ children }) {
...
export function AltBox({ content }) {
  return (
...
export function AbilityScore({ ability }) {
  const skills = {
    strength: [
      'Saving Throws',
      'Athletics',
  ...
  return (
    <>
      ...
      <div className={styles.skill_list}>
        { ability === 'Strength' && (
          skills.strength.map((element, i) => (<Skill name={element} key={i} />))
        )}
        { ability === 'Dexterity' && (
          skills.dexterity.map((element, i) => (<Skill name={element} key={i} />))
        )}
        { ability === 'Constitution' && (
          skills.constitution.map((element, i) => (<Skill name={element} key={i} />))
        )}
        { ability === 'Intelligence' && (
          skills.intelligence.map((element, i) => (<Skill name={element} key={i} />))
        )}
        { ability === 'Wisdom' && (
          skills.wisdom.map((element, i) => (<Skill name={element} key={i} />))
        )}
        { ability === 'Charisma' && (
          skills.charisma.map((element, i) => (<Skill name={element} key={i} />))
        )}
      </div>
    </>
  );
...
export function PersonalityBox({ name, children }) {
  return (
  ...
  return (
    <div className={styles.features_wrapper}>
      ...
      <p>
        ...
        such dreams are actually mental exercises
...
export function Feature({ children, style }) {
  return (
...
export function SmallFeature({ children, style }) {
  return (
...
export function AltBoxBG() {
  return (
    <svg viewBox="0 0 70 45">
      <polygon fill="#FEFEFE" points="68.8,22.5 55.8,43.3 14.2,43.3 1.2,22.5 14.2,1.8 14.3,1.7 55.7,1.7 55.8,1.8 " />
      <path fill="#000000" d="M59.1,0H10.9L0,17.2v10.5L10.9,45H59l11-17.2V17.2L59.1,0z M58.2,2.2l10,15.8v3L56.5,2.3l-0.1-0.1H58.2z M14.8,2.2h40.5 l0.1,0.1L68,22.5L55.3,42.8H14.7L2,22.5L14.8,2.2L14.8,2.2z M1.8,18l10-15.8h1.8l-0.1,0.1L1.8,21V18z M11.8,42.8L1.8,27v-3 l11.7,18.8H11.8z M68.2,27l-10,15.8h-1.7L68.2,24V27z" />
    </svg>
  );
}

export function PersonalityBoxBG() {
  return (
    <svg viewBox="0 0 317 88.98">
      <path fill="#FEFEFE" d="M9.35,8,7,10.29a38.78,38.78,0,0,1,.35,6.19l.85,57c0,4.29.29,6.67,3.67,9.37l3.76,2.46c2.56,2,19.53,1.87,9.58,1.87l271.48-.68c3.29,0,5.19-2.23,7.75-4.28l3-2.64c3.38-2.7,1.7-2.4,1.7-6.69L310,17.06c0-4.28-.76-8-4.13-10.71h0a18.9,18.9,0,0,0-10.39-3.64L19.59,2.48A36.38,36.38,0,0,0,9.35,8Z" />
...
export function FrameBG() {
  return (
    <svg viewBox="0 0 517 660">
      <path fill="#D8D8D8" d="M509.2,646.2c-1.7,5.7-12.9,11.7-14.5,11.7H22.5c-1.7,0-12.8-6-14.5-11.7L8.2,19.3V12S16.1,2.3,23.4,1.4H493.80005c7.3.8,15.1,10.6,15.1,10.6v7.3Z" />
...
export function SmallFrameBG() {
  return (
    <svg viewBox="0 0 344 95">
      <polygon fill="#FEFEFE" points="8 93 337 93 337 2 8 2 8 93" />
...
export function AltSmallFrameBG() {
  return (
    <svg viewBox="0 0 317 88.98">
      <path fill="#FEFEFE" d="M9.35,8,7,10.29a38.78,38.78,0,0,1,.35,6.19l.85,57c0,4.29.29,6.67,3.67,9.37l3.76,2.46c2.56,2,19.53,1.87,9.58,1.87l271.48-.68c3.29,0,5.19-2.23,7.75-4.28l3-2.64c3.38-2.7,1.7-2.4,1.7-6.69L310,17.06c0-4.28-.76-8-4.13-10.71h0a18.9,18.9,0,0,0-10.39-3.64L19.59,2.48A36.38,36.38,0,0,0,9.35,8Z" />
      <path fill="#000000" d="M305.89,0H11.1L0,9V79.93l11.1,9H305.89l11.11-9V9ZM294.34,86.5H22.6A24.06,24.06,0,0,1,8.69,78.78V10.24a24.36,24.36,0,0,1,14-7.76H294.4a24.09,24.09,0,0,1,13.91,7.72V78.73a24.36,24.36,0,0,1-14,7.77ZM3.05,21.16a27.77,27.77,0,0,1,4-8.79V76.63c-.37-.53-.76-1-1.09-1.62a27.78,27.78,0,0,1-2.89-7.1ZM310,12.34c.37.54.76,1.05,1.09,1.62A28,28,0,0,1,314,21.07V67.81a27.91,27.91,0,0,1-4,8.8Zm4-2.27v7a26.94,26.94,0,0,0-4-6.77v-.13h-.1a24.53,24.53,0,0,0-11.24-7.68h6ZM12.37,2.48h6A24.53,24.53,0,0,0,7.13,10.16H7v.13a26.94,26.94,0,0,0-4,6.77v-7ZM3.05,78.91v-7a26.81,26.81,0,0,0,4,6.78v.13h.1A24.61,24.61,0,0,0,18.37,86.5h-6ZM304.63,86.5h-6a24.61,24.61,0,0,0,11.24-7.68h.1v-.13a26.81,26.81,0,0,0,4-6.78v7Z" />
